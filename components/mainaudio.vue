...
.main-audio > .description-block {
  width: 80%;
  height: 22%;
  margin: 0 auto;
}

.main-audio > .description-block > h1 {
  font-size: 1.8em;
  font-weight: normal;
}
